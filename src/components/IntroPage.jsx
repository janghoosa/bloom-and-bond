        ...
        <div className="relative space-y-4 sm:space-y-6">
          <div className="space-y-4 sm:space-y-5">
            ...
            <p className="max-w-2xl text-sm leading-7 sm:text-base" style={{ color: theme.textSoft }}>
              MBTI와 애착유형을 함께 분석해서, 성향 위에 숨은 관계 반응까지 읽어보세요.
            </p>
            <div className="flex flex-col gap-3 sm:flex-row sm:items-center">
              <PrimaryActionButton onPress={onStart} fullWidth={false}>검사 시작하기</PrimaryActionButton>
              <span className="text-xs" style={{ color: theme.textSoft }}>약 5분 · 서버 저장 없음</span>
            </div>
            <p className="max-w-2xl text-xs leading-6" style={{ color: theme.textSoft }}>
                ...
                <>
                  ...
                  <div className="flex flex-col gap-2 sm:flex-row">
                    ...
                    <button
                      ...
                      className="min-h-[44px] rounded-[20px] border px-4 py-1.5 text-sm"
